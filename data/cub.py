...
def get_cub_datasets(train_transform, test_transform, train_classes=range(160), prop_train_labels=0.8,
    ...
    print(f'total={len(whole_training_set)} trainl={len(train_dataset_labelled)} test={len(test_dataset)} trainu={len(train_dataset_unlabelled)}')
...
### >>>
def get_cub_datasets_with_gcdval(train_transform, test_transform, train_classes=range(80), 
